...
static struct ft5x0x_i2c_platform_data ft5x0x_pdata = {
    ...
    .screen_max_x   = 1024,//768,
    .screen_max_y   = 600,//1024,
    .pressure_max   = 255,
};
#if 0
static int __init setup_width_height(char *str)
{
    if (!strncasecmp("9.7", str, 3)) {
        ...
        ft5x0x_pdata.screen_max_x = 600;// 768;
...
static struct rt5640_data rt5640_pdata = {
        .capless                = 0,
        .dres                   = RT5640_DRES_400R,
};

/* I2C4 */
static struct i2c_board_info i2c_devs4[] __initdata = {
        {
                I2C_BOARD_INFO("rt5640", 0x1c),         //by lin,rt5640-0x1c
                .platform_data  = &rt5640_pdata,
        },
};
#endif
...
{
    // .gpio		= EXYNOS4_GPX1(1),  //by lin @20150721 for UART_RING
    .gpio            = EXYNOS4_GPX1(3),
    //.code		= 10,
    .code		= KEY_HOMEPAGE,
    .desc		= "BUTTON1",
...
// modify by gw only value of code
{
    .gpio           = EXYNOS4_GPX2(0),
    //.code         = 38,
    .code           = KEY_VOLUMEDOWN,
...
static uint32_t smdk4x12_keymap[] __initdata = {
    /* KEY(row, col, keycode) */
    #if 0  
   /* KEY(0, 0, KEY_VOLUMEUP), KEY(0, 1, KEY_VOLUMEDOWN),*/ 
    KEY(0, 2, KEY_HOME), KEY(0, 3, KEY_MENU), KEY(0, 4, KEY_BACK),KEY(0, 5, KEY_POWER)	//volume up ---volume down
    #else
...
#endif
//add by gw
#ifdef CONFIG_RST_CTL
struct platform_device s3c_device_rst_ctl = {
    .name  ="rst",
    .id     = -1,
};
#endif
...
//add by lin
struct platform_device s3c_device_switchs_ctl = {
        .name   ="switchs",
        .id             = -1,
};
//end by lin
