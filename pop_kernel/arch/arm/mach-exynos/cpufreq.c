			  ...
			  unsigned int relation)
{
	...
	//arm_volt += 45000;
	//arm_volt = 1350000;
	//safe_arm_volt = 1350000;//1345000;
	//printk("fun:%s, line = %d(old_index:%d, index:%d, freq_new:%d, freq_old:%d, safe_arm_volt:%d, arm_volt:%d)\n", __FUNCTION__, __LINE__, old_index, index, freqs.new, freqs.old, safe_arm_volt, arm_volt);
