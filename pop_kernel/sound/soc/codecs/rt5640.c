 ...
 * published by the Free Software Foundation.
 ...
 Modification: 
 		1.add mute control;
 		2.change register for default setting;
 		3.set pll param;
--------------------------------------------------------------- 
 */
...
/*add by lin, add macro*/ 
#define ASRC 				//for ASRC FUNCTION
//#define LOUT_SWITCH		//no dapm open/close lout switch
#define TEST				//for
#define I2SC				//slave mode,PCM1-IS1,PCM2-IS2
#define MY_COUNT			//set PLL param 
#define INLR_RANGE	23		//by lin , INLR VOL RANGE
/*- by lin
...
#include <asm/io.h>
#define MUTE_GPIO EXYNOS4_GPX1(1)    //GONGFANG GPIO
#endif
...
//#define PWR_INIT	//add by lin for pwr init @20150811
...
static struct rt5640_init_reg init_list[] = {
	//{RT5640_DUMMY1		, 0x3771},//- by lin , ADC as ASRC, fa[12:13] = 1'b; fa[8~10]=1; fa[0]=1
#ifdef ASRC
	{RT5640_DUMMY1		, 0x1771},	//by lin , for I2S2 ADC switch @20150810
#endif
	...
	{RT5640_ADDA_CLK1	, 0x1114},//@20150813-16
	{RT5640_JD_CTRL		, 0x0003},	//by lin for I2S2 @20150810
    ...
    //{RT5640_OUT_L3_MIXER  , 0x01ee},//by lin , OUT MIXL INL  
    //{RT5640_OUT_R3_MIXER  , 0x01ee},//by lin , OUT MIXR INR
	{RT5640_HP_VOL		, 0x9696},//OUTMIX -> HPVOL -10db
	//{RT5640_HPO_MIXER	, 0xc000},//HPVOL -> HPOLMIX
	{RT5640_OUT_L3_MIXER    , 0x01ed},//by lin , OUT MIXL INL , DACL1 unmute OUTMIXL
	{RT5640_OUT_R3_MIXER    , 0x01eb},//by lin , OUT MIXR INR , DACL2 unmute OUTMIXR
	{RT5640_HPO_MIXER       , 0x8000},//by lin , HPVOL -> HPOLMIX , DAC -> HPOLMIX
	{RT5640_DAC1_DIG_VOL    , 0x8e8e},//add by lin for DAC volume 9696
	/*- by lin*/
...
//	{RT5640_SPO_R_MIXER	, 0x1800},//DAC -> SPORMIX
	/*end by lin*/
#ifdef I2SC
	{RT5640_I2S1_SDP	, 0x8000},//by lin, slave mode,PCM1-IS1,PCM2-IS2
	{RT5640_ADDA_CLK2	, 0xAC00},	//by lin , Mono DACL over Sample rate
#else
	{RT5640_I2S1_SDP	, 0xd000},//by lin, I2S interchange 
	{RT5640_I2S2_SDP	, 0x8082},
#endif
	
	/*record*/
	//{RT5640_IN1_IN2		, 0x5080},//IN1 boost 40db and differential mode
	{RT5640_IN1_IN2         , 0x0080},//IN1 boost 0db and differential mode
	//{RT5640_IN3_IN4		, 0x0540},//IN2 boost 40db and differential mode
	{RT5640_IN3_IN4         , 0x0500},//by lin , IN2 boost 40db and single mode
...
//	{RT5640_STO_ADC_MIXER	, 0x1000},//ADC -> Sto ADC mixer
	/* end by lin */
	{RT5640_STO_ADC_MIXER	, 0x3060},//by lin,ADC -> Sto ADC L1 mixer
	...
	{RT5640_STO_DAC_MIXER	, 0x1404},		//by lin , DACL2 mute STO
	//{RT5640_LOUT_MIXER	, 0x3000},		//by lin , dac1 - outvol old 0x3000
	//{RT5640_LOUT_MIXER	, 0xc000},		//by lin ,OUT VOL - LOUTMIX
	//{RT5640_OUTPUT, 0x9696},				//by lin, OUTMIX -OUT VOL , lout mute
	{RT5640_OUTPUT		, 0x1616},				//by lin , OUTMIX -OUT VOL , lout unmute
	{RT5640_DSP_PATH2	, 0x0800},			//by lin , IF2 ADC L Mux
    /* add by lin ,for ASRC function*/
#ifdef ASRC 
    {RT5640_ASRC_1		, 0x9b00},
    {RT5640_ASRC_2		, 0xf820},
#endif    
#ifdef PWR_INIT
	{RT5640_PWR_DIG1,	0xd8c4},
	{RT5640_PWR_DIG2,	0x4000},
	{RT5640_PWR_ANLG1,	0xf8fc},
	{RT5640_PWR_ANLG2,	0x8e00},
	{RT5640_PWR_MIXER,	0xc800},
	{RT5640_PWR_VOL,	0x3f00},
#endif	
	{RT5640_MONO_ADC_MIXER,0x3070},
	{RT5640_MONO_DAC_MIXER,0x4454},	//0x4454  cjp@015-8-14
	{RT5640_ADC_DIG_VOL,0x5a5a},	//lin@20150918
	//end by lin
	//{RT5640_OUTPUT, 0x8888} 	//by lin , =8888 , 0db - 31  
	//{RT5640_OUTPUT, 0x9696},	//by lin , 9292, -10db
...
static const u16 rt5640_reg[RT5640_VENDOR_ID2 + 1] = {
	...
	[RT5640_OUTPUT] = 0xc8c8,		//by lin , old [RT5640_OUTPUT] = 0xc8c8,
	...
	[RT5640_LOUT_MIXER] = 0x3000,			//by lin, dac - vol
	[RT5640_PWR_ANLG1] = 0x00c0,
#ifdef I2SC
	[RT5640_I2S1_SDP] = 0x8000,//slave mode		//by lin, slave mode,PCM1-IS1,PCM2-IS2
	[RT5640_I2S2_SDP] = 0x8000,
#else
	[RT5640_I2S1_SDP] = 0xd000,//I2S interchange 
	[RT5640_I2S2_SDP] = 0x8082,
#endif
...
static const struct snd_kcontrol_new rt5640_snd_controls[] = {
	...
	SOC_DOUBLE_EXT_TLV("HP Playback Volume", RT5640_HP_VOL,
		...
		rt5640_vol_rescale_get, rt5640_vol_rescale_put, out_vol_tlv),
	/*ADD BY LIN*/
	 SOC_DOUBLE_EXT_TLV("INLR Playback Volume", RT5640_INL_INR_VOL,
        RT5640_L_VOL_SFT, RT5640_R_VOL_SFT, RT5640_VOL_RSCL_RANGE, 0,
        rt5640_vol_rescale_get, rt5640_vol_rescale_put, out_vol_tlv),
	SOC_DOUBLE("HP Playback VOL Switch", RT5640_HP_VOL,
			 ...
			 struct snd_soc_dapm_widget *sink)
{
	...
	//if (val == RT5640_SCLK_SRC_PLL1)	by lin for PLL1 power up
		return 1;
	//else	by lin
	//	return 0;	by lin
}
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT5640_OUTPUT,
			RT5640_L_MUTE | RT5640_R_MUTE, 0);
		/* add by lin */
		printa("rt5640_lout_event , SND_SOC_DAPM_POST_PMU, UN-MUTE \n");	
		#ifdef MUTE_EVENT
			msleep(20);
			gpio_set_value(MUTE_GPIO, 1);
			printa("gong fang UN-MUTE ,POST_PMU\n");
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		snd_soc_update_bits(codec, RT5640_OUTPUT,
			RT5640_L_MUTE | RT5640_R_MUTE,
			RT5640_L_MUTE | RT5640_R_MUTE);
		printa("rt5640_lout_event , SND_SOC_DAPM_PRE_PMD, MUTE \n");
		break;
			     ...
			     struct snd_kcontrol *kcontrol, int event)
{
	...
	printa("rt5640_asrc_event");

	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		if (rt5640->asrc_en[RT5640_AIF1] ||rt5640->asrc_en[RT5640_AIF2]) 
		{		
			printa("SND_SOC_DAPM_PRE_PMU , ASRC OPEN\n");
			snd_soc_update_bits(w->codec,RT5640_DUMMY1, 0x70, 0x70);
			snd_soc_update_bits(w->codec,RT5640_JD_CTRL, 0x3, 0x3);
			snd_soc_write(w->codec, RT5640_ASRC_1, 0x9b00);
			snd_soc_write(w->codec, RT5640_ASRC_2, 0xf800);
		}
		break;
	case SND_SOC_DAPM_POST_PMD:
		printa("SND_SOC_DAPM_POST_PMD , ASRC CLOSE\n");
		snd_soc_write(w->codec, RT5640_ASRC_1, 0x0);
		snd_soc_write(w->codec, RT5640_ASRC_2, 0x0);
		snd_soc_update_bits(w->codec,RT5640_JD_CTRL, 0x3, 0);
		snd_soc_update_bits(w->codec,RT5640_DUMMY1, 0x70, 0);
		break;
	default:
		return 0;
	}
...
static const struct snd_soc_dapm_widget rt5640_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY_S("ASRC Function", 1, SND_SOC_NOPM,
			0, 0, rt5640_asrc_event,SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	/*SND_SOC_DAPM_PRE("ASRC Function",rt5640_asrc_event),
	end by lin*/
...
static int get_sdp_info(struct snd_soc_codec *codec, int dai_id)
{
	...
	switch (dai_id) {
	case RT5640_AIF1:
		printa("lin test , get_sdp_info, RT5640_AIF1\n");
		if (val == RT5640_IF_123 || val == RT5640_IF_132 ||
			val == RT5640_IF_113){
			ret |= RT5640_U_IF1;
			printa("lin test , ret |= RT5640_U_IF1\n");
			}
		if (val == RT5640_IF_312 || val == RT5640_IF_213 ||
			val == RT5640_IF_113){
			ret |= RT5640_U_IF2;
			printa("lin test , RT5640_U_IF2\n");
			}			
		if (val == RT5640_IF_321 || val == RT5640_IF_231)
			{
			ret |= RT5640_U_IF3;
			printa("lin test , RT5640_U_IF3\n");
			}			
		break;

	case RT5640_AIF2:
		printa("lin test , get_sdp_info, RT5640_AIF2\n");
		...
		if (val == RT5640_IF_123 || val == RT5640_IF_321 ||
			val == RT5640_IF_223){
			ret |= RT5640_U_IF2;
			printa("lin test , ret |= RT5640_U_IF2\n");
			}
		if (val == RT5640_IF_132 || val == RT5640_IF_312){
			ret |= RT5640_U_IF3;
			printa("lin test , ret |= RT5640_U_IF3\n");
			}
		break;
	...
	struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
	unsigned int val_len = 0, val_clk = 0, mask_clk = 0, dai_sel = 0;
	int pre_div = 0, bclk_ms = 0 , frame_size = 0;

	rt5640->lrck[dai->id] = params_rate(params);
	printa("check 1 , lrck = %d\n",rt5640->lrck[dai->id]);
	
	pre_div = get_clk_info(rt5640->sysclk, rt5640->lrck[dai->id]);
	printa("check 2 , pre_div = %d\n",pre_div);
	...
	printa("check 4 , bclk_ms = %d\n",bclk_ms);
	
	rt5640->bclk[dai->id] = rt5640->lrck[dai->id] * (32 << bclk_ms);
	printa("check 5 , bclk = %d\n",rt5640->bclk[dai->id]);

	switch (params_format(params)) {
	case SNDRV_PCM_FORMAT_S16_LE:
		printa("SNDRV_PCM_FORMAT_S16_LE , break\n");
		break;
		...
		int clk_id, unsigned int freq, int dir)
{
	...
	if (freq == rt5640->sysclk && clk_id == rt5640->sysclk_src){
		printa("lin test , rt5640_set_dai_sysclk , freq == rt5640->sysclk ,return 0\n");
		return 0;
	}
	...
	case RT5640_SCLK_S_MCLK:
		...
		printa("lin check , RT5640_SCLK_S_MCLK\n");
		break;
	case RT5640_SCLK_S_PLL1:
		reg_val |= RT5640_SCLK_SRC_PLL1;
		printa("lin check , RT5640_SCLK_S_PLL1\n");
		break;
	...
	const unsigned int freq_out, struct rt5640_pll_code *pll_code)
{
	...
	printa("lin test , Only get approximation about PLL\n");
...
code_find:
	...
	/*add by lin ,for pll check*/
	printa("lin test , pll_code->m_code = %d , pll_code->n_code = %d\n", m,n);
	return 0;
}
			...
			unsigned int freq_in, unsigned int freq_out)
{
	...
	if (!freq_in || !freq_out) {
		dev_info(codec->dev, "PLL disabled , return\n");
...
/*	change by lin ,just for 4.096M and  44.1k*512 = 22579200Hz*/
...
/*	if(freq_in != freq_out)
...

	{
		int val;
		#ifdef MUTE_CTRL
        printa("before pll setting, set mute\n");
		gpio_set_value(MUTE_GPIO, 0);
        printa("sleep 100\n");     
		msleep(100);
        #endif
	...
	dev_err(codec->dev, "pll_in = %d  ,  pll_out = %d , pll_src = %d\n", rt5640->pll_in,
			rt5640->pll_out, rt5640->pll_src);
	return 0;
}
...
static int rt56xx_hwdep_ioctl(struct snd_hwdep *hw, struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case AUDIO_CAPTURE_MODE:
		switch(arg){
			...
			case OUTPUT_SOURCE_VOICE:
				...
				break;
			case END_RECORDING:
				//do_rt5640_dsp_set_mode(rt5640_audio_codec,RT5640_DSP_DIS); - by lin
				break;
			case START_COMMUNICATION:
                            printk("AUDIO_CODEC: Capture mode [%s]\n",
				arg == START_COMMUNICATION ? "COMMUNICATION" : "NORMAL");
				if(arg == START_COMMUNICATION){
					//do_rt5640_dsp_set_mode(rt5640_audio_codec,RT5640_DSP_AEC_NS_FENS); - by lin
				}
				break;
	...
	case RT_GET_CODEC_DSP_MODE_IOCTL:
		//return rt56xx_dsp_ioctl_common(hw, file, cmd, arg);  - by lin 
#endif
	default:
		return rt56xx_hwdep_ioctl_common(hw, file, cmd, arg);
#endif
...
static int rt5640_probe(struct snd_soc_codec *codec)
{
	...
	//@20150814 codec->dapm.bias_level = SND_SOC_BIAS_PREPARE;
	rt5640->codec = codec;
	rt5640_audio_codec = codec;
	rt5640_dsp = rt5640;
	//rt5640->dsp_sw = RT5640_DSP_AEC_NS_FENS; - by lin
...
static int rt5640_suspend_i2c(struct i2c_client  *codec, pm_message_t state)
{
	...
	//tegra_gpio_enable(TEGRA_GPIO_PW4);	- by lin
	//ret = gpio_request(TEGRA_GPIO_PW4, "audio_mclk");	- by lin
	if (ret < 0)
		pr_err("%s: gpio_request failed for gpio %s\n",__func__, "AUDIO_MCLK");
	//gpio_direction_output(TEGRA_GPIO_PW4, 0);	- by lin
	//gpio_free(TEGRA_GPIO_PW4);	- by lin
	printk("rt5640_suspend_i2c-\n");
	return 0;
}
...
static int rt5640_resume_i2c(struct i2c_client  *codec)
{
	...
	//tegra_gpio_disable(TEGRA_GPIO_PW4);	- by lin
...
struct i2c_driver rt5640_i2c_driver = {
	...
	//edit by lin for sleep test .suspend = rt5640_suspend_i2c,    
	//edit by lin for sleep test .resume	= rt5640_resume_i2c,
	.probe = rt5640_i2c_probe,
	//edit by lin for sleep test .remove   = __devexit_p(rt5640_i2c_remove),
	//edit by lin for sleep test .shutdown = rt5640_i2c_shutdown,
