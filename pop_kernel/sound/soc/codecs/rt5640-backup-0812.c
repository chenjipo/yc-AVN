...
#include <asm/io.h>
#define MUTE_GPIO EXYNOS4_GPX1(6)	//mute gpio
#endif
...
static struct rt5640_init_reg init_list[] = {
	...
	//{RT5640_ADDA_CLK1	, 0x1114},//73[2] = 1'b		by lin
	{RT5640_ADDA_CLK1 	, 0x0014},	//by lin for I2S2 @20150810
	...
	{RT5640_OUT_L3_MIXER    , 0x01ef},//by lin , OUT MIXL INL
	{RT5640_OUT_R3_MIXER    , 0x01ef},//by lin , OUT MIXR INR
	...
	struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	if (dai_sel & RT5640_U_IF1) {
		printa("USE I2S1\n");
		pre_div = 0;            //pre_div = 0 , by lin @20150810
	...
	if (dai_sel & RT5640_U_IF2) {
		printa("USE I2S2\n");
		pre_div = 0;			//pre_div = 0 , for PLL = 4096000 by lin @20150810
...
/*	change by lin ,just for 4.096M and  44.1k*512 = 22579200Hz*/
	...
	dev_err(codec->dev, "bypass=%d m=%d n=%d k=2\n", pll_code.m_bp,
...
static int rt5640_probe(struct snd_soc_codec *codec)
{
	...
	//by lin codec->dapm.bias_level = SND_SOC_BIAS_STANDBY;
